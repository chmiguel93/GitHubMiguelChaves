      ...
      if ($("#formulario-principal").validate().form() === true){
            ...
            $.ajax({
                ...
                success: function(data){
                    if (data == '1'){
                        $("#msgbox").html("Empleado Creado Exitosamente.");
...
<div style="width:80%; padding: 1%">
  ...
  <form id="formulario-principal">
    <div class="form-group">
    	<input type="hidden" id="tipo_persona" name="tipo_persona" value="2"> <!-- Es de tipo 2 por que es un empleado-->
    ...
    <div class="form-group">
      <label for="cargo">Seleccione Cargo del empleado</label>
